...
var ChoosingSettingsContainer = React.createClass({
    ...
    render: function() {
        ...
        var topbar = <TopBar 
            ...
            title={<AppTitle subtitle={this.props.choice.name + ": Choosing Settings"} />}
        />;
...
module.exports = ChoosingSettingsContainer;